...
namespace UniMod.Editor {
    ...
    public static partial class UniModEditorUtility {
        ...
        public static void RefreshAndSaveAllEmbeddedModConfigs() {
            const string MOD_CONFIG_FILTER = "t:" + nameof(ModConfig);
            string[] configGuids = AssetDatabase.FindAssets(MOD_CONFIG_FILTER);
            ...
            foreach (string guid in configGuids) {
                ...
                if (!config || !config.linkedEmbeddedConfig) continue;
