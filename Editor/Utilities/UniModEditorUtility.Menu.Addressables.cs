...
namespace UniMod.Editor {
    public static partial class UniModEditorUtility {
        const string AddressablesMenu = "UniMod/Addressables";
        
        [MenuItem(AddressablesMenu + "/Reload Groups Editor")]
        public static void ReloadAddressablesGroupsEditor() {
            if (AddressableAssetsWindow is null || GroupEditorField is null || ReloadMethod is null) return;
        ...
        public static void FixAddressablesLabels() {
            ...
            if (settings) FixAddressablesLabels(settings);
        }
...
#region REFLEXION_INFO
        static readonly Type AddressableAssetsWindow =
        ...
        static readonly FieldInfo GroupEditorField =
            AddressableAssetsWindow.GetField("m_GroupEditor", BindingFlags.Instance | BindingFlags.NonPublic);
        
        static readonly Type AddressableAssetsSettingsGroupEditor =
            AppDomain.CurrentDomain
                .GetAssemblies()
                .Select(assembly => assembly.GetTypes()
